...
consvar_t cv_drawdist = CVAR_INIT ("drawdist", "2048", CV_SAVE, drawdist_cons_t, NULL);
consvar_t cv_drawdist_nights = CVAR_INIT ("drawdist_nights", "2048", CV_SAVE, drawdist_cons_t, NULL);
consvar_t cv_drawdist_precip = CVAR_INIT ("drawdist_precip", "None", CV_SAVE, drawdist_precip_cons_t, NULL);

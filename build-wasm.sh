...
emcmake cmake .. -DCMAKE_BUILD_TYPE=Release \
    ...
    "-DCMAKE_C_FLAGS=-O3 -ffast-math -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s USE_SDL_MIXER=2 -s USE_SDL_TTF=2 -s USE_ZLIB=1 -s USE_LIBPNG=1 -s ASYNCIFY=1 -I$VCPKG_INC" \
    "-DCMAKE_CXX_FLAGS=-O3 -ffast-math -I$VCPKG_INC" \
    "-DCMAKE_EXE_LINKER_FLAGS=-s GL_MAX_TEMP_BUFFER_SIZE=2097152 -s GL_PREINITIALIZED_CONTEXT=1 -O2 -s WASM_BIGINT=1 -s EMSCRIPTEN=1 -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s USE_SDL_MIXER=2 -s USE_SDL_TTF=2 -s USE_ZLIB=1 -s USE_LIBPNG=1 -s ASYNCIFY=1 -s INITIAL_MEMORY=536870912 -s MAXIMUM_MEMORY=2147483648 -s ALLOW_MEMORY_GROWTH=1 -s NO_EXIT_RUNTIME=1 -s USE_WEBGL2=1 -s LEGACY_GL_EMULATION=1 -s EMULATE_FUNCTION_POINTER_CASTS=1 -s GL_UNSAFE_OPTS=0 -s EXPORTED_RUNTIME_METHODS=['ccall','cwrap','UTF8ToString'] -L$VCPKG_LIB", \
